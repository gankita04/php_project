  ...
  <tbody>
      ...
      $sum = 0;
        while($ans = $result->fetch_assoc()):
          $sum = $sum + ($ans['proprice'] - ($ans['proprice']*$ans['prodiscount']/100) );
      ?>
    <tr>
      <th scope="row">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <?php
              $posted['surl'] = "http://localhost/kshitij/ecommerce/success.php"
          ?>
        ...
        <tr>
          <td>Failure URI: </td>
          <?php
              $posted['furl'] = "http://localhost/kshitij/ecommerce/failure.php"
          ?>
